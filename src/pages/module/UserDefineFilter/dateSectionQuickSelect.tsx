 ...
 * @param param0 
 */
export const DateSectionQuickSelect = ({ form, fieldName, callback }:
    { form?: any, fieldName?: string, callback?: Function }) => {
    ...
    const getButtons = () => {
        let key = 1;
        return <Space direction="vertical" size="small" key='space_1' >
