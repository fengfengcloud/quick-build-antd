...
const SettingForm = ({ moduleState, dispatch }:
    ...
    return (
        <Card title="列表导出设置" size="small" style={{ border: '0px' }}>
            <Form form={form}
                ...
                <Row gutter={0}>
                    <Col span={12}>
                        <Form.Item name="usemonetary" label="加入当前数值单位" valuePropName="checked" style={style}>
                            <Switch />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                    ...
                    <Col span={12}>
                        <Form.Item name="unitalone" label="计量单位单独一行" valuePropName="checked" style={style}>
                            <Switch />
                        </Form.Item>
                    </Col>
