...
const ImageField: React.FC<ImageFieldProps> = ({ value,
    onChange = (value: string | null) => { }, label, readOnly,
    imageHeight = 96, imageWidth = 96, imageStyle = {borderRadius : '8px'} }) => {
    ...
    return (
        <div className={styles.avatar}>
            ...
            <img width={imageWidth} height={imageHeight} style={imageStyle}
