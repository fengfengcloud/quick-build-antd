...
import { FilterDataSourceModal } from '../data';
...
export const ConditionGrid = () => {
    ...
    const columns: any = [
        {
            ...
            width: 36,
            align: 'center',
            render: (value: any, record: FilterDataSourceModal) => <Tooltip title="删除此条件"><DeleteOutlined
                onClick={() => {
    ...
    return <Card className='dataminingcard' style={{ marginBottom: '16px' }}>
        <Table
